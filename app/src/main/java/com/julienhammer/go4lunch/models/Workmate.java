...
public class Workmate {
    private Drawable wkmImage;
    private String wkmText;

    public Workmate(Drawable wkmImage, String wkmText) {
        this.wkmImage = wkmImage;
        this.wkmText = wkmText;
    }

    public Drawable getWkmImage() {
        return wkmImage;
    }

    public void setWkmImage(Drawable wkmImage) {
        this.wkmImage = wkmImage;
    }

    public String getWkmText() {
        return wkmText;
    }

    public void setWkmText(String wkmText) {
        this.wkmText = wkmText;
    }
}
